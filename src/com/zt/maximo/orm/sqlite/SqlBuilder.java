 ...
 */
package com.zt.maximo.orm.sqlite;
...
import com.zt.maximo.orm.table.Property;
import com.zt.maximo.orm.table.TableId;
...
public class SqlBuilder {
	 ...
	 * @return
	 */
	public static SqlInfo buildDeleteSql(Class<?> clazz , String strWhere,Object[] args){
		TableInfo table=TableInfo.get(clazz);
		StringBuffer strSQL = new StringBuffer(getDeleteSqlBytableName(table.getTableName()));
	 ...
	 * @return
	 */
	public static SqlInfo getUpdateSqlAsSqlInfo(Object entity,String  strWhere,Object[] args){
